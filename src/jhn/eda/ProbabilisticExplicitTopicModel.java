...
import jhn.eda.listeners.ProbabilisticExplicitTopicModelListener;
...
*/
public abstract class ProbabilisticExplicitTopicModel implements Serializable {
	...
	private List<ProbabilisticExplicitTopicModelListener> listeners = new ArrayList<>();
	...
	public ProbabilisticExplicitTopicModel (TopicCounts topicCountsFact, TypeTopicCounts typeTopicCounts,
	...
	public ProbabilisticExplicitTopicModel(TopicCounts topicCounts, TypeTopicCounts typeTopicCounts,
...
//						System.err.println("No instances of '" + type + "' (" + typeIdx + ") in topic corpus");
						...
						if (newTopic == -1) {
							throw new IllegalStateException (ProbabilisticExplicitTopicModel.class.getName()+": New topic not sampled.");
						}
...
//		}
	...
	public void addListener(ProbabilisticExplicitTopicModelListener l) {
		listeners.add(l);
	}
	...
	private void fireSamplerInit() throws Exception {
		for(ProbabilisticExplicitTopicModelListener l : listeners) {
			l.samplerInit(this);
		}
	}
	
	private void fireIterationStarted(int iteration) throws Exception {
		for(ProbabilisticExplicitTopicModelListener sl : listeners) {

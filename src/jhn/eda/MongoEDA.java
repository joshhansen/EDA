...
public class MongoEDA extends EDA {
	...
	public MongoEDA(DBCollection c, Alphabet targetAlphabet, LabelAlphabet topicAlphabet,
...
//		final String datasetFilename = System.getenv("HOME") + "/Projects/eda_java/toy_dataset2.mallet";
		...
		try {
			...
			MongoEDA eda = new MongoEDA (c, targetAlphabet, targetLabelAlphabet, 50.0, 0.01, new Randoms());
